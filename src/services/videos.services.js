async function getOEmbed(videoUrl) {
    try {
        const response = await fetch(`https://strengthvault-api-strengthvaults-projects.vercel.app/api/oembed`, {
            method: 'POST',
            headers: {
...
async function getVideos() {
  return fetch('https://strengthvault-api-strengthvaults-projects.vercel.app/api/blogs', {  // Cambia la URL por la correcta si es diferente
      method: 'GET',
      headers: {
...
async function findByVideoId(id) {
    return fetch(`https://strengthvault-api-strengthvaults-projects.vercel.app/api/blogs/${id}`, {
        method: 'GET',
        headers: {
            'Content-Type': 'application/json',
...
async function createVideo(blog) {
    ...
    try {
        const response = await fetch(`https://strengthvault-api-strengthvaults-projects.vercel.app/api/blogs/upload`, {
            method: 'POST',
            headers: {
                'auth-token': localStorage.getItem('token'),
                'Content-Type': 'application/json',
